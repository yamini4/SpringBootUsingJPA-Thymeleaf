...
public class CategoriesController {
    ...
    public String category(@PathVariable String slug, Model model, @RequestParam(value="page", required = false) Integer p) {
        ...
        if(slug.equals("all")){
            ...
            List<Product> products = productRepository.findAllByCategoryId(String.valueOf(categoryId),pageable);

            count = productRepository.countByCategoryId(String.valueOf(categoryId));
